      ...
      <div class="card-body">
        <form action="products?action=edit" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" name="name" id="id-name" class="form-control" value="${product.name}">
          </div>

          <div class="form-group">
            <label for="id-price">Valor</label>
            <input type="text" name="price" id="id-price" class="form-control" value="${product.value}">
          </div>

          <div class="form-group">
            <label for="id-amount">Quantidade</label>
            <input type="text" name="amount" id="id-amount" class="form-control" value="${product.amount}">
          </div>

          <div class="form-group">
            <label for="id-fabrication">Data de Fabricação</label>
            <input type="date" name="fabrication" id="id-fabrication" class="form-control" value="${product.fabricationDate}">
          </div>
          ...
          <div class="form-group">
            ...
            <select name="category" id="id-category" class="form-control">
              ...
              <c:forEach items="${categories}" var="c">
                <c:if test="${c.code == product.category.code}">
